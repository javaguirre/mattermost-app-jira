...
var Manifest = apps.Manifest{
	...
	HomepageURL: "https://github.com/mattermost/mattermost-app-jira",
	...
	Deploy: apps.Deploy{
		HTTP: &apps.HTTP{
			RootURL: "http://mattermost-app-jira:4000",
		},
	},
}
...
func main() {
	...
	fmt.Println("Use '/apps install http http://mattermost-app-jira" + addr + "/manifest.json' to install the app") // matches manifest.json
